...
export default function App() {
  ...
  return (
    <div className="h-full w-full flex bg-ink-900 text-ink-100 overflow-hidden">
      ...
      {/* Popup pós-origem: marcar saída é OBRIGATÓRIO.
          Sem botão "Pular" e sem dismiss via backdrop — única saída é clicar
          em "Marcar saída", que entra em pickingDestination e fecha o popup. */}
      <AnimatePresence>
        {showDestPrompt && (
          <motion.div
              ...
              <div className="flex items-start gap-3 md:gap-4 mb-5 md:mb-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[12px] md:text-[13px] text-ink-400 mt-1.5 leading-relaxed">
                    ...
                    saída da cidade. Esse passo é obrigatório.
                  </div>
                </div>
              </div>
              <Button
